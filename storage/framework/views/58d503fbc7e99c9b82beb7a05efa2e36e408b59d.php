    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <h2>Nama : <?php echo e($content ['mahasiswa']['nama']); ?></h2>
                <h2>NIM : <?php echo e($content ['mahasiswa']['nim']); ?></h2>
            </div>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\tugasweb\resources\views/admin/beranda.blade.php ENDPATH**/ ?>